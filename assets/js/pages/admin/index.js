...
async function fetchStatistics() {
  try {
    ...
    draw_donut(data.by_statut);
    dessingDeLaBar(data.by_priorite);
    affecherLesRecents(data.recent);
    ...
    affichercatgoriBAr(data.by_categorie);
    afficherBarAgent(data.by_agent);
  } catch (err) {
    console.error(err);
  }
}

function draw_donut(byStatut) {
...
function dessingDeLaBar(byPriorite) {
...
function affecherLesRecents(rows) {
...
function affichercatgoriBAr(byCategorie) {
...
function afficherBarAgent(byAgent) {
